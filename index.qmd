...
![Bias-Variance tradeoff in ML](images/bias_variance-01.png){alt="Bias-Variance tradeoff in ML"}
...
![A very Malaysian decision tree](images/decision_trees-02.png){alt="A very Malaysian decision tree"}

Each part of the tree has its own definitions

![Some definitions](images/decision_trees_definitions.png){alt="Some definitions"}
...
![Dummy data on Prediciting Samyang love](images/dt_eg1.png){alt="Dummy data on Prediciting Samyang love"}

![Calculating Gini Impurity for Sex variable](images/dt_eg2-01.png){alt="Calculating Gini Impurity for Sex variable"}

![Calculating Gini Impurity for Loves Blackpink variable](images/dt_eg3-01.png){alt="Calculating Gini Impurity for Loves Blackpink variable"}
...
![Adding leaves and labelling outputs](images/dt_eg4.png){alt="Adding leaves and labelling outputs"}
...
![Random forests](images/random_forest.png){alt="Random forests"}
...
![Threshold Classification](images/svm_eg1.png){alt="Threshold Classification"}
...
![Maximal margin classification](images/svm_eg2.png){alt="Maximal margin classification"}
...
![Effect of the outlier](images/svm_eg3.png){alt="Effect of the outlier"}
...
![Soft Margins](images/svm_eg4.png){alt="Soft Margins"}
...
![Soft margins in two dimensional space](images/2d_svm_eg.png){alt="Soft margins in two dimensional space"}
...
![Soft margins in three dimensional space](images/3d_svm_eg.png){alt="Soft margins in three dimensional space"}
...
![Training Data overlap](images/poly_eg1.png){alt="Training Data overlap"}
...
![A Radial Basis Function Kernel](images/rbf.png){alt="A Radial Basis Function Kernel" fig-align="center"}
...
![Gradient Boosting Algorithm](images/gb.png){alt="Gradient Boosting Algorithm"}
...
![Gradient Descent](images/descent.png){alt="Gradient Descent"}
...
![K-folds cross validation](images/cv_kfolds.png){alt="K-folds cross validation"}
...
### ![K-folds cross validation for Grid Search and Hyperparameter tuning](images/cv_kfolds_gridsearch.png){alt="K-folds cross validation for Grid Search and Hyperparameter tuning"}
...
![Importance of Explaining your Model](images/explainable.png){alt="Importance of Explaining your Model"}

SHAP stands for Shapley Additive Explanations. It is model agnostic, efficient algorithm to compute feature importance.

![Shapley equation](images/shapley-equation-01.png){alt="Shapley equation"}
...
shap <- explain(extract_fit_engine(shap_final), X_pred = shap_df_prep, X = shap_sample_df)
```
...
```{r}
sv_force(shap, row_id = shap$X$income_B40==0)
```
...
-   For use only within SBDR- PLEASE DO NOT SHARE OUTSIDE OF SBDR WITHOUT PERMISSION AS DATA WAS ONLY UTILISED FOR INTERNAL CIRCULATION.
